...
parser.add_argument("interface", help="No shutdown interface number")
...
logger = getLogger("conf_int_noshut")
...
test_mod.conf_interface_noshut(dev, int_list)
dev.disconnect()

message = "Successfully no shutdown interface {0} of {1} !!".format(
    int_arg, dev)
